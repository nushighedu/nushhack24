...
export function ContractForm({ user, onSubmit, onCancel }: ContractFormProps) {
  ...
  return (
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">Government Agencies</label>
          <Input
              placeholder="Government agencies related to this contract... e.g., LTA, GovTech, DSTA"
              value={contract.agencies || ''}
              onChange={(e) => setContract({...contract, agencies: e.target.value})}
          />
        </div>
